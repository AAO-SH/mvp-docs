...
```
Agent(
  prompt="Read C:/Users/cyborg/Documents/aao-protocol/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/cyborg/Documents/aao-protocol/.codex/get-shit-done/templates/SECURITY.md`
